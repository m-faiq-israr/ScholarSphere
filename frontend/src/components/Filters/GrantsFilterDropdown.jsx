  ...
  return (
    <div className="relative inline-block text-left font-outfit" ref={dropdownRef}>
      <button
        ...
        className="inline-flex select-none items-center gap-1 md:gap-2 rounded-xl bg-heading-1 py-2 px-3 text-xs md:text-sm font-medium text-white shadow-inner shadow-white/10 focus:outline-none hover:bg-gray-700"
      >
        Filters
